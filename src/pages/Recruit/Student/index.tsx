  ...
  return (
    <Spin spinning={publishItemR.loading}>
      {/* <form className={style.container} onSubmit={handleSubmit} onInput={checkValidate.run}>
        <Input type='text' bind={name} name='比赛名称' />
        <Input type='Date' bind={time} name='比赛时间' dateCallback={handleDate}/>
        <Textarea bind={introduction} name='比赛简介' />
        <Input type='text' bind={organizer} name='队长' />
        <Input type='text' bind={communicate} name='队长电话' />
        <Input type='text' bind={needNum} name='招募队员人数' />
        <Textarea bind={claim} name='招募要求' />
        <Button type='submit' value='确定' className={style.btn} />
      </form> */}
      <form className={style.container} onSubmit={handleSubmit} onInput={checkValidate.run}>
        <Input type='text' onInput={validateName.run} bind={name} name='比赛名称' msg={validateMsg.mName.msg} warn={validateMsg.mName.warn} />
        <Input type='text' onInput={validateLocation.run} bind={location} name='比赛地点' msg={validateMsg.location.msg} warn={validateMsg.location.warn} />
        <Input type='Date' onInput={validateTime.run} bind={time} name='比赛时间' dateCallback={handleDate} msg={validateMsg.startTime.msg} warn={validateMsg.startTime.warn} />
        <Textarea onInput={validateIntroduction.run} bind={introduction} name='比赛简介' msg={validateMsg.introduction.msg} warn={validateMsg.introduction.warn} />
        <Input type='text' bind={organizer} name='队长' />
        <Input type='text' bind={communicate} name='队长电话' />
